...
const CHANGELOG = [
  {
    ...
    date: '2026-08-15',
    items: [
      '🤏 Drag a timeline note to another date and it follows your cursor while the target column lights up. Dropping anywhere in a column works, and the note lands at the bottom of that day',
