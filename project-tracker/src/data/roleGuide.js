    ...
    roles: [
      ...
      },
      {
        ...
        sources: [
          ...
          'Communication needs from other roles',
        ],
      },
      {
        name: 'Social Media',
        summary: "Shares the team's story online while maintaining a professional and consistent public image.",
        objectives: [
          'Create posts about meetings, outreach, sponsors, and competitions.',
          'Maintain a regular posting schedule.',
          'Photograph or record team activities with permission.',
          'Recognize sponsors and community partners.',
          'Monitor engagement and improve future content.',
        ],
        sources: [
          'The team calendar',
          'Outreach and competition activities',
          'Sponsor-recognition commitments',
          'Team branding and safety policies',
          'Updates provided by technical and business members',
        ],
      },
    ],
  },
