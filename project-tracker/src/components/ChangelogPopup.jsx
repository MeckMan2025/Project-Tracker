...
const CHANGELOG = [
  {
    ...
    items: [
      ...
      '\u270F\uFE0F You can edit a notebook entry you already wrote \u2014 tap the pencil on it. Leads can edit anyone\'s. Changing the date while editing moves that entry instead of making a second one',
