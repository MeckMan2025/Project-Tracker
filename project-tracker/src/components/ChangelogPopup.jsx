...
const CHANGELOG = [
  {
    ...
    items: [
      ...
      '\u23F0 The notebook deadline is the end of the meeting day. Once a day is over, anyone without an entry for it is marked absent. Absent is final \u2014 writing the entry afterwards completes your notebook but does not give the meeting back, so write it on the day. Being late or leaving early never marks you absent on its own; only a missing entry does. Today stays open, and leads can settle it early from the session',
