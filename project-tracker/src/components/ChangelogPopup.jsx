...
const CHANGELOG = [
  {
    ...
    items: [
      ...
      '\u23F0 The notebook deadline is the end of the meeting day. Once a day is over the attendance for it settles itself: no entry means absent, and an entry written late wins your present back. Being late or leaving early never marks you absent on its own \u2014 only a missing entry does. Today stays open, and leads can settle it early from the session',
